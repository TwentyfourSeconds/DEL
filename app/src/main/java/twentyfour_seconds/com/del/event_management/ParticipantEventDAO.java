...
class ParticipantEventDAO extends AsyncTask<String, String, String> {
    ...
    ParticipantEventDAO(String urlStr, String write, EventInfoDTOList eventInfoDTOList, CountDownLatch latch) {
        this.urlStr = urlStr;
        this.write = write;
