...
//    private String textArr[] = {"dev2qa.com", "is", "a very good", "android example website", "there are", "a lot of", "android, java examples";
    ...
    textbuttonClickListener tukueText = new EventCreate3.textbuttonClickListener();
    textbuttonClickListener missituText = new EventCreate3.textbuttonClickListener();
    textbuttonClickListener cityTypeText = new EventCreate3.textbuttonClickListener();
    textbuttonClickListener outFieldText = new EventCreate3.textbuttonClickListener();
...
//          ret配列に、設定した文字列を追加
    ...
    public class  contentCheckButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            Intent EventCreate4Page = new Intent(getApplicationContext(), EventCreate4.class);
