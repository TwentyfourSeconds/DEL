...
class EventSearchNameDAO extends AsyncTask<String, String, String> {
    ...
    EventSearchNameDAO(int number, String searchWord, EventInfoDTOList eventInfoDTOList, CountDownLatch latch) {
        this.number = number;
    ...
    EventSearchNameDAO(int number, EventInfoDTOList eventInfoDTOList, CountDownLatch latch) {
        this.number = number;
        this.eventInfoDTOList = eventInfoDTOList;
        this.latch = latch;
    }

    EventSearchNameDAO(String searchWord, EventInfoDTOList eventInfoDTOList, CountDownLatch latch) {
        this.searchWord = searchWord;
        this.eventInfoDTOList = eventInfoDTOList;
        this.latch = latch;
    }

    EventSearchNameDAO(CountDownLatch latch) {
        this.latch = latch;
    }
...
//    }
    ...
    protected String doInBackground(String... string) {
        String urlStr = Common.EVENT_SEARCH_NAME_URL;
        String write = "";
        String result = "";
